...
// PurpleRobotClient.serverUrl = "http://165.124.199.231:12345/json/submit";
// PurpleRobotClient.serverUrl = "http://192.168.1.33:12345/json/submit";

PurpleRobotClient.serverUrl = "http://localhost:12345/json/submit";

// PurpleRobotClient.serverUrl = "http://192.168.43.1:12345/json/submit";



PurpleRobotClient.launchRequest = "PurpleRobot.fetchEncryptedString('appConfig');";
PurpleRobotClient.lastResponse = null;
PurpleRobotClient.loadPrompt = null;
PurpleRobotClient.app_config = {};
...
PurpleRobotClient.emitReading = function (name,value,emission_format,options) {
    options = options || {};
    name = name || app.config.datastore || "app_eav";
...
PurpleRobotClient.setUserId = function (contents,emission_format) {
    js_to_execute = 'PurpleRobot.setUserId(\"' + contents + '\");'
    return PurpleRobotClient.actionHandler(js_to_execute, emission_format);
}

PurpleRobotClient.fetchUserId = function (emission_format) {
    js_to_execute = 'PurpleRobot.fetchUserId();'
    return PurpleRobotClient.actionHandler(js_to_execute, emission_format);
}
